/* eslint-disable */
// disabling eslint as this file is auto generated by newRelic
const { NEW_RELIC_KEYS } = process.env;
const {
  NEW_RELIC_APPID,
  NEW_RELIC_ACCOUNTID,
  NEW_RELIC_TRUSTKEY,
...
NREUM.loader_config = {
  accountID: NEW_RELIC_ACCOUNTID,
  trustKey: NEW_RELIC_TRUSTKEY,
  agentID: NEW_RELIC_APPID,
  licenseKey: NEW_RELIC_LICENSEKEY,
  applicationID: NEW_RELIC_APPID,
};
NREUM.info = {
